        ...
        <>
          ...
          <div className="modal">
            <form className="modal-box" onSubmit={handleSubmit(onSubmit)}>
              ...
              <p className="py-4">
                This will create your Election Poll with valid candidates!
              </p>
              ...
              <div>
                <div className="inline-grid w-full mb-4 sm:mb-6">
                  ...
                  <input
                    {...register("name")}
                    type="text"
                    placeholder="What is your Election Name"
                ...
                <div className="inline-grid w-full mb-4 sm:mb-6">
                  ...
                  <input
                    ...
                    type="text"
                    max={100}
                    placeholder="Give a description of your Election"
                    className="input border border-solid border-[white] rounded-sm bg-[rgba(255, 255, 255, 0.03)] shadow-[0px_4px_0px_rgba(0,0,0,0.25)]"
                  />
                  <p className="text-red-500 text-xs italic pt-1">
                ...
                <div className="inline-grid w-full mb-4 sm:mb-6">
                  ...
                  <select
                    {...register("type")}
                    className="select select-bordered  border border-solid border-[white] rounded-sm bg-[rgba(255, 255, 255, 0.03)] shadow-[0px_4px_0px_rgba(0,0,0,0.25)]"
                  >
                ...
                <div className="inline-grid w-full mb-4 sm:mb-6">
                  ...
                  <TagsInput
                    ...
                    classNames={{
                      tag: "border rounded-sm bg-[#cdcfde] p-2",
              ...
              <div className="modal-action flex">
                <button
                  ...
                  onClick={() =>
                    dispatch({ type: "CLOSE_CREATE_ELECTION_MODAL" })
                  }
                >
                  Cancel
                </button>
                {createLoading ? (
                  <button className="btn-border bg-[#cdcfde] px-8 rounded flex justify-center items-center w-[220px] mx-auto gap-4">
