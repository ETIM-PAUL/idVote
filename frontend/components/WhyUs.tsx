  ...
  return (
    <div id="apps" className="app_cards_bg sm:py-10 px-6 sm:px-16 py-4">
      <div className="text-white">
        <h3
          className="text-center leading-normal mb-16 sm:text-start block font-normal tracing-[-0.128px] text-[#CDCFDE] sm:text-[64px] text-[48px]"
      ...
      <div className="flex flex-wrap justify-center gap-20 text-white">
        {why_us.map((why, index) => (
          ...
          >
            <h3 className="text-2xl sm:text-4xl block text-center">
              {why?.title}
            </h3>
            <p className="text-xl sm:text-2xl grotesk font-normal leading-[25.5px] sm:leading-10 tracking-[0.085px] px-6 mt-4">
              {why.detail}
            </p>
          </div>
        ))}
